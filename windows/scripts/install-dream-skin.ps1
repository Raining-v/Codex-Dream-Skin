...
$content = Read-Utf8TextFile -LiteralPath $ConfigPath
$content = Set-DreamSkinDesktopConfig -Content $content
Write-Utf8TextFile -LiteralPath $ConfigPath -Value $content
